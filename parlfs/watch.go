...
import (
	...
	"github.com/haraldrudell/parl/parltime"
)
...
// Events returns a receiver channel for parlfs.WatchEvent
	...
	defer func() {
		if err != nil && watcher != nil {
			if e := wa.watcher.Close(); e != nil {
				err = error116.AppendError(err, parl.Errorf("watcher.Close: %w", e))
			}
		}
	}()
