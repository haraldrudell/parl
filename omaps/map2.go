...
func newMap[K comparable, V any]() (m *map2[K, V]) { return &map2[K, V]{m2: *pmaps.NewMap[K, V]()} }

func (m *map2[K, V]) Get(key K) (value V, ok bool) { return m.m2.Get(key) }

func (m *map2[K, V]) Length() (length int) { return m.m2.Length() }

func (m *map2[K, V]) Range(rangeFunc func(key K, value V) (keepGoing bool)) { m.m2.Range(rangeFunc) }
