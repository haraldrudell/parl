...
var actionSet = sets.NewSet(sets.NewElements[Action](
	[]sets.SetElement[Action]{
		{ValueV: AddHost, Name: "new host"},
		{ValueV: DeleteHost, Name: "delete host"},
		{ValueV: HostReport, Name: "host"},
		{ValueV: IfAddAddr, Name: "address"},
		{ValueV: IfDeleteAddr, Name: "delete address"},
		{ValueV: IfStatus, Name: "if status"},
		{ValueV: AddMulticast, Name: "add multicast"},
		{ValueV: DeleteMulticast, Name: "delete multicast"},
		{ValueV: AddRoute, Name: "add route"},
		{ValueV: DeleteRoute, Name: "delete route"},
		{ValueV: Partition, Name: "demoted"},
		{ValueV: RouteReport, Name: "report"}, // a route does not have a prefix other than 0/0 or 192.168.1.21/32
	}))
