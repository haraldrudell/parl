...
// AggregatingPriorityQueue implements a priority queue using
// cached priority from aggregators
...
type AggregatingPriorityQueue[V any, P constraints.Ordered] struct {
	...
	queue parli.Ordered[parl.AggregatePriority[V, P]]
...
var _ = ((parl.AggregatingPriorityQueue[int, int])(&AggregatingPriorityQueue[int, int]{})).Clear
...
func (a *AggregatingPriorityQueue[V, P]) insert(aggregatePriority parl.AggregatePriority[V, P]) {
